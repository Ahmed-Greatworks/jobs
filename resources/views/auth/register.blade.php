            ...
            <div class="border-b border-white/10 pb-12">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="first_name" type="text" name="first_name" placeholder="John" required/>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="last_name" type="text" name="last_name" placeholder="Doe" required/>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="email" type="email" name="email" placeholder="john@example.com" required/>
